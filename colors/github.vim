...
call s:Col('airlineN1',       'white', 'base0')
call s:Col('airlineN2',       'white', 'base1')
call s:Col('airlineN3',       'white',  'grey1')
call s:Col('airlineInsert1',  'white', 'blue')
call s:Col('airlineInsert2',  'white', 'darkblue')
call s:Col('airlineVisual1',  'white', 'purple')
call s:Col('airlineVisual2',  'white', 'darkpurple')
call s:Col('airlineReplace1', 'white', 'red')
call s:Col('airlineReplace2', 'white', 'darkred')
